...
static const char* ACLIENT_TABLE[] = {
    ...
    "<tr><th>进程 ID</th><th>连接地址</th><th>目的地址</th><th>吞吐量</th></tr>\n",
    "</table>\n" };
...
static const char REQUEST_GUIDE[] =
    "<h3>可用的HTTP请求:</h3>\n"
    "<table cellspacing=\"0\">\n"
        "<tr><th>请求模板</th><th>功能</th></tr>\n"
        "<tr><td><small>http://<i>address:port</i>/udp/<i>mcast_addr:mport/</i></small></td>\n"
        "<td>从mcast_addr:mport中继多播流量</td></tr>"
        "<tr><td><small>http://<i>address:port</i>/status/</small></td><td>显示udpxy状态</td></tr>\n"
        "<tr><td><small>http://<i>address:port</i>/restart/</small></td><td>重新启动udpxy</td></tr>\n"
    "</table>\n";
